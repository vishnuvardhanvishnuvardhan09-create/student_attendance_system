...
export default function StudentLayout() {
  ...
  const navItems = [
    { label: 'Overview', path: '/student', Icon: LayoutDashboard, exact: true },
    { label: 'Mark Attendance', path: '/student/mark', Icon: MapPin },
    { label: 'Attendance History', path: '/student/history', Icon: ClipboardList },
    { label: 'Monthly Analysis', path: '/student/analysis', Icon: BarChart3 },
    { label: 'Academic Holidays', path: '/student/holidays', Icon: CalendarDays },
    { label: 'Notice Board', path: '/student/notices', Icon: Bell },
    { label: 'Submit Feedback', path: '/student/feedback', Icon: MessageSquare },
    { label: 'Profile & ID Badge', path: '/student/profile', Icon: QrCode },
  ];

  return (
    <div className="portal-container" style={{ display: 'flex', minHeight: '100vh', background: '#090d16', color: '#f8fafc' }}>
      {/* Persistent Left Sidebar with Distinct Cyan / Sky Blue Accent */}
      <aside
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '28px', paddingLeft: '8px' }}>
          ...
          <div>
            ...
            <div style={{ fontSize: '0.75rem', color: '#38bdf8', fontWeight: 600 }}>
              {user.rollNumber || 'Academic Portal'}
            </div>
          </div>
        </div>

        {/* Logged-in Student Profile Bar with Avatar */}
        <div
          style={{
            display: 'flex',
            alignItems: 'center',
        ...
        >
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            ...
            <div style={{ fontSize: '0.72rem', color: '#38bdf8', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
              {user.rollNumber || user.email || 'Student Account'}
            </div>
          </div>
        </div>
        ...
        <div style={{ borderTop: '1px solid rgba(255, 255, 255, 0.08)', paddingTop: '16px', marginTop: 'auto' }}>
          <div style={{ paddingLeft: '8px', marginBottom: '12px' }}>
            ...
            <div style={{ fontSize: '0.72rem', color: '#0ea5e9', marginTop: '2px', fontWeight: 600 }}>
              {user.department || 'Department'} &bull; Yr {user.year || 1}-{user.section || 'A'}
            </div>
          </div>
          <button
